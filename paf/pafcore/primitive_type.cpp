...
{
	return Primitive_op_binary(result, args, numArgs, &CPPPrimitiveType::op_add);
}

ErrorCode CPPPrimitiveType::Primitive_op_subtract(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_binary(result, args, numArgs, &CPPPrimitiveType::op_subtract);
}

ErrorCode CPPPrimitiveType::Primitive_op_multiply(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_binary(result, args, numArgs, &CPPPrimitiveType::op_multiply);
}

ErrorCode CPPPrimitiveType::Primitive_op_divide(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_binary(result, args, numArgs, &CPPPrimitiveType::op_divide);
}

ErrorCode CPPPrimitiveType::Primitive_op_mod(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_binaryIntegerOnly(result, args, numArgs, &CPPPrimitiveType::op_mod);
}

ErrorCode CPPPrimitiveType::Primitive_op_bitwiseAnd(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_binaryIntegerOnly(result, args, numArgs, &CPPPrimitiveType::op_bitwiseAnd);
}

ErrorCode CPPPrimitiveType::Primitive_op_bitwiseOr(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_binaryIntegerOnly(result, args, numArgs, &CPPPrimitiveType::op_bitwiseOr);
}

ErrorCode CPPPrimitiveType::Primitive_op_bitwiseXor(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_binaryIntegerOnly(result, args, numArgs, &CPPPrimitiveType::op_bitwiseXor);
}

ErrorCode CPPPrimitiveType::Primitive_op_leftShift(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_binaryIntegerOnly(result, args, numArgs, &CPPPrimitiveType::op_leftShift);
}

ErrorCode CPPPrimitiveType::Primitive_op_rightShift(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_binaryIntegerOnly(result, args, numArgs, &CPPPrimitiveType::op_rightShift);
}
...
{
	return Primitive_op_compare(result, args, numArgs, &CPPPrimitiveType::op_less);
}

ErrorCode CPPPrimitiveType::Primitive_op_lessEqual(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_compare(result, args, numArgs, &CPPPrimitiveType::op_lessEqual);
}

ErrorCode CPPPrimitiveType::Primitive_op_equal(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_compare(result, args, numArgs, &CPPPrimitiveType::op_equal);
}

ErrorCode CPPPrimitiveType::Primitive_op_notEqual(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_compare(result, args, numArgs, &CPPPrimitiveType::op_notEqual);
}

ErrorCode CPPPrimitiveType::Primitive_op_greaterEqual(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_compare(result, args, numArgs, &CPPPrimitiveType::op_greaterEqual);
}

ErrorCode CPPPrimitiveType::Primitive_op_greater(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_compare(result, args, numArgs, &CPPPrimitiveType::op_greater);
}
...
{
	return Primitive_op_compoundAssign(result, args, numArgs, &CPPPrimitiveType::op_add);
}

ErrorCode CPPPrimitiveType::Primitive_op_subtractAssign(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_compoundAssign(result, args, numArgs, &CPPPrimitiveType::op_subtract);
}

ErrorCode CPPPrimitiveType::Primitive_op_multiplyAssign(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_compoundAssign(result, args, numArgs, &CPPPrimitiveType::op_multiply);
}

ErrorCode CPPPrimitiveType::Primitive_op_divideAssign(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_compoundAssign(result, args, numArgs, &CPPPrimitiveType::op_divide);
}

ErrorCode CPPPrimitiveType::Primitive_op_modAssign(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_compoundAssign_IntegerOnly(result, args, numArgs, &CPPPrimitiveType::op_mod);
}

ErrorCode CPPPrimitiveType::Primitive_op_bitwiseXorAssign(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_compoundAssign_IntegerOnly(result, args, numArgs, &CPPPrimitiveType::op_bitwiseXor);
}

ErrorCode CPPPrimitiveType::Primitive_op_bitwiseAndAssign(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_compoundAssign_IntegerOnly(result, args, numArgs, &CPPPrimitiveType::op_bitwiseAnd);
}

ErrorCode CPPPrimitiveType::Primitive_op_bitwiseOrAssign(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_compoundAssign_IntegerOnly(result, args, numArgs, &CPPPrimitiveType::op_bitwiseOr);
}

ErrorCode CPPPrimitiveType::Primitive_op_leftShiftAssign(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_compoundAssign_IntegerOnly(result, args, numArgs, &CPPPrimitiveType::op_leftShift);
}

ErrorCode CPPPrimitiveType::Primitive_op_rightShiftAssign(Variant* result, Variant** args, int_t numArgs)
{
	return Primitive_op_compoundAssign_IntegerOnly(result, args, numArgs, &CPPPrimitiveType::op_rightShift);
}
